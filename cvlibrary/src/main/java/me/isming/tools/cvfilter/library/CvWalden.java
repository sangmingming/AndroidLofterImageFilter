...
public class CvWalden implements ICVFilter{
    ...
    public ImageData convert(ImageData source) {
        ...
        Bitmap localBitmap = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.filter_ol2);
        ...
        LibCvFilter.CvWalden(arrayOfInt2, arrayOfInt1, width, height, source.a);
    ...
    @Override
    public int getResId() {
        return R.drawable.filter_aicao;
    }
}
