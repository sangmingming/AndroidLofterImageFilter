 ...
 */
public class CvHudson implements ICVFilter{

    Context mContext;

    public CvHudson(Context context) {
        mContext = context;
    }
    ...
    public ImageData convert(ImageData source) {
        ...
        Bitmap localBitmap = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.filter_hdb);
        ...
        LibCvFilter.CvHudson(arrayOfInt2, arrayOfInt1, width, height, source.a);
    ...
    @Override
    public int getResId() {
        return R.drawable.filter_qingse;
    }
}
