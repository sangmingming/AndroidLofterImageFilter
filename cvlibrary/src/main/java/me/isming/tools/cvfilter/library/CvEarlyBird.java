 ...
 */
public class CvEarlyBird implements ICVFilter{

    Context mContext;

    public CvEarlyBird(Context context) {
        mContext = context;
    }
    ...
    public ImageData convert(ImageData source) {
        ...
        LibCvFilter.CvEarlyBird(arrayOfInt2, arrayOfInt1, width, height, source.a);
    ...
    @Override
    public int getResId() {
        return R.drawable.filter_natie;
    }
}
