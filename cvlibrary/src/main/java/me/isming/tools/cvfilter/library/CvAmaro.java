 ...
 */
public class CvAmaro implements ICVFilter {

    Context mContext;

    public CvAmaro(Context context) {
        mContext = context;
    }
    ...
    public ImageData convert(ImageData source) {
        ...
        LibCvFilter.CvAmaro(arrayOfInt2, arrayOfInt1, width, height, source.a);
    ...
    @Override
    public int getResId() {
        return R.drawable.filter_shentou;
    }
}
