 ...
 */
public class CvLomo implements ICVFilter{

    Context mContext;

    public CvLomo(Context context) {
        mContext = context;
    }
    ...
    public ImageData convert(ImageData source) {
        ...
        LibCvFilter.CvLomo(arrayOfInt2, arrayOfInt1, width, height, source.a);
    ...
    @Override
    public int getResId() {
        return R.drawable.filter_chenjiang;
    }
}
